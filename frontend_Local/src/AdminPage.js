    ...
    if (value === 0) {
      return (
        <div>
          ...
          {/* ... other file management content ... */}
          <Button onClick={handleCloseFileManagement}>Back to Main Page</Button>
          <div>
            <div id="uploadStatus"></div>
            <Box ml={2}>
              <h5>Insurance Selection</h5>
              <p style={{ textAlign: "justify" }}>
                Choose a file that contains details for teams to check insurance
                options
              </p>
              <input
                type="file"
            ...
            <Box ml={2}>
              ...
              <p style={{ textAlign: "justify" }}>
                Choose a file that contains details for teams to check marketing
                options
              </p>
              <input
                type="file"
      ...
      // Cotton tab is selected
      return (
        <div>
          {/* Cotton-specific file management content */}
          <Typography variant="h4" component="h2" gutterBottom>
            Cotton Files Management
          </Typography>
          {/* ... Cotton file upload components ... */}
          <Button onClick={handleCloseFileManagement}>Back to Main Page</Button>
          <div>
            <div>
              <div id="uploadStatus"></div>
                  ...
                  {cottondefaultfiles
                    ...
                    .map((fileName, index) => (
                      <ListItem key={index}>
                        <ListItemText primary={fileName} />
                        <Link
                          href={`/api/downloadDefaultCottonFile/${fileName}`}
                          download
                        >
                          Download
                        </Link>
                        <Button
                          onClick={() => handlecottondefaultDelete(fileName)}
                        >
                          Delete
                        </Button>
                        {/* <Link
    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <Button
            variant="contained"
            color="secondary" // Change the color for distinction, if desired
                            ...
                            >
                              ...
                              <TableBody>
                                {Irrigationapplications.filter(
                                  ...
                                  ) // Filter data for "soil-moisture" option
                                  .sort(
                                    (a, b) =>
                                      new Date(a.date) - new Date(b.date)
                                  )
                      ...
                      <TabPanel value={value1} index={7}>
                        ...
                        <div>
                          ...
                          {/* <Box ml={2}>
                            <h5>Insurance Selection</h5>
                            <p style={{ textAlign: "justify" }}>
                              Choose a file that contains details for teams to
                  ...
                  <div>
                    <div>
                      ...
                      <TabPanel value={value1} index={2}>
                        ...
                        {seedingcottonsubmittedForms.length > 0 &&
                          selectedUser && (
                            <div>
                              <Typography variant="h5" gutterBottom>
                                Submitted Forms
